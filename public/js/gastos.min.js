$(document).ready(function() {
    ...
    var table = $('.datatable').DataTable({
        ...
        dom: '<"row"<"col-12 col-sm-12 col-md-6"><"col-12 col-sm-12 col-md-6">>rt<"top"l><"col-12"i>p',
    });
...
$(function() {
    $("#form_agregar").on("submit", function(e) {
        ...
        $.ajax({
            ...
            success: function(data) {
                f[0].reset();
                $("#form_agregar input[name=impuesto]").focus();
...
function totales() {
    ...
    $.ajax({
        ...
        dataType: "json",
        success: function(data) {
            $('.td_costo_total').html(data.costo_total);
            $('.td_costo').html(data.costo);
        }
    });
}