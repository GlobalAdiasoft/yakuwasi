...
<div class="container-fluid font_azul">
    <div class="row">
        <div class="col-12">
            <hr>
            <h4 class="font_azul"><i class="fa fa-bars" aria-hidden="true"></i> Ver Nota de Crédito</h4>
            <span class="font_azul"><i class="far fa-edit"></i> Aqui podra ver las notas de créditos</span>
            <hr>
        </div>
        <div class="col-12">
