...
<div class="container-fluid">
   <div class="row">
      <div class="col-12 col-md-3">
         <hr>
         <h5 class=""><i class="fa fa-bars" aria-hidden="true"></i> Nuevos Fabricante</h5>
         <small><i class="far fa-edit"></i>Aquí podrá agregar nuevos fabricantes</small>	
         <hr>
         <form id="form_agregar" action="<?php echo URL?>Fabricantes/agregar" method="post">
            ...
            <div class="form-group row">
               ...
               <div class="col-7">
                  <input class="form-control form-control-sm" type="text" name="nombre" placeholder="Ingrese nombre de fabricante" required>
               </div>
            </div>
           <div class="form-group row">
      ...
      <div class="col-12 col-md-9">
         <hr>
         <h5 class=""><i class="fa fa-bars" aria-hidden="true"></i> Lista de Fabricantes</h5>
         <small><i class="far fa-edit"></i> Aquí podrá ver toda la información de todos los fabricantes</small>
         <hr>
         <div class="container">
        <div class="row">
          <div class="col-12" >
 ...
 <form id="form_modificar" action="<?php echo URL?>Fabricantes/modificar" method="post" class="ocultar">
