...
<div class="container-fluid">
   <div class="row">
      <div class="col-12 col-md-3">
         <hr>
         <h5 class=""><i class="fa fa-bars" aria-hidden="true"></i> Nuevas Ubicaciones</h5>
         <small><i class="far fa-edit"></i>Aquí podrá agregar nuevas ubicaciones</small>
         <hr>
         <form id="form_agregar" action="<?php echo URL ?>Ubicacion/agregar" method="post">

            <div class="form-group row">
               <label for="" class="col-5 ">Nombre :</label>
               <div class="col-7">
                  <input class="form-control form-control-sm" type="text" name="nombre" placeholder="Ingrese nombre de ubicacion" required autocomplete="off">
               </div>
            </div>
           <div class="form-group row">
      ...
      <div class="col-12 col-md-9">
         <hr>
         <h5 class=""><i class="fa fa-bars" aria-hidden="true"></i> Lista de Ubicaciones</h5>
         <small><i class="far fa-edit"></i> Aquí podrá ver toda la información de todas las ubicaciones</small>
         <hr>
         <div class="container">
        <div class="row">
          <div class="col-12" >
