...
<div class="container-fluid font_azul">
    <div class="row">
        <div class="col-12">
            <hr>
            <h4 class="font_azul"><i class="fa fa-bars" aria-hidden="true"></i> Nota de Débito</h4>
          
            <hr>
        </div>
        <div class="col-12 col-lg-6 col-xl-6">
         <form id="form_agregar" action="<?php echo URL?>Notadebito/agregar" method="post">
            <div class="row">
             ...
             <div class="row">
              <div class="col-12 col-lg-4 col-xl-4">
                ...
                <div class="col-12 ">
                 ...
                 <div class="col-12 ">
                    <div class= "form-group">
                        <label for="">Tipo Nota de Débito: </label>
