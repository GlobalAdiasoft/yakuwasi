...
<div class="container-fluid font_azul">
  <div class="row">
    <div class="col-12">
      <hr>
      <h4 class="font_azul"><i class="fa fa-bars" aria-hidden="true"></i> Factura</h4>
      ...
      <form id="form_agregar_factura" action="<?php echo URL?>Pedidos/agregar_pedidos" method="post">
          ...
          <div class="col-12 col-lg-8 col-xl-8">
            <div class="form-group">
              ...
              <div class="input-group mb-2 mr-sm-2 mb-sm-0" style="z-index: 0;">
                ...
                <button  id="btn_agregar"  type="button" class="input-group-addon btn btn-sistema2 btn-sm" data-hm-modal="m_agregar_cliente"><small><i class="fa fa-plus-circle" aria-hidden="true"></i>    </small>
                </button>
        ...
        <div class="row">
          <div class="col-12 text-center">
            <div class="form-group">
              <button id="btn_facturar" type="button" class="btn btn-dark">Procesar Factura</button>
        ...
        <input type="hidden" name="tipo_documento" readonly value="FAC">
